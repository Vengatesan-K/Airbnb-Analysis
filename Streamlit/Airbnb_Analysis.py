...
# Plot 2: Count Plot of Property Types (Top 10)
  ...
  #------------------#  
    ...
    df1 = pd.read_csv(r"C:/Users/VENKA/Desktop/Data Science/Python Anaconda/Project/airbnb_analysisf.csv")
    sum_prices_by_year = df1.groupby('year')['price'].sum().reset_index()

    sum_prices_by_year.columns = ['year', 'total_price']

    fig = px.line(sum_prices_by_year, x='year', y='total_price', title='Total Price by Year')
    fig.update_xaxes(type='category')
    fig.update_layout(width=1200, height=500)  # You can adjust width and height as needed
    st.plotly_chart(fig)
